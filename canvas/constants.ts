...
const others_shapes: {
...
}[] = [
   {
      scale: 0.5,
      type: "path",
      I: "/shapes/others/decoration-garland.svg",
      path: "M52.554,122.909L85.629,87.32l27.411-29.497C85.9,52.236,59.08,45.054,32.716,36.303l8.99,39.247 L52.554,122.909z M168.583,101.939l18.909,44.758l26.392-40.792l21.874-33.81 c-27.768-0.792-55.428-3.214-82.839-7.242L168.583,101.939z M276.248,72.092l21.868,33.804l26.392,40.797l18.909-44.758l15.668-37.095 C331.675,68.872,304.014,71.298,276.248,72.092z M398.964,57.81l27.408,29.491l33.075,35.592l10.848-47.361l8.989-39.25 C452.921,45.034,426.101,52.217,398.964,57.81z  M419.819,204.035c-27.019,6.418-54.372,11.243-81.921,14.448l24.752,31.794l29.845,38.339 l14.936-46.234L419.819,204.035z M278.738,257.624l18.856-35.614c-13.848,0.816-27.731,1.224-41.627,1.224 c-13.871,0-27.731-0.409-41.558-1.218l18.857,35.607l22.736,42.94L278.738,257.624z M149.351,250.288l24.754-31.799c-27.548-3.202-54.903-8.022-81.92-14.439l12.384,38.342 l14.934,46.235L149.351,250.288z",
   },
   {
      scale: 5,
      type: "path",
      I: "/shapes/others/decoration-line.svg",
      path: "M12,1a1,1,0,0,0-1,1v9.586L6.293,16.293a1,1,0,0,0,0,1.414l5,5a1,1,0,0,0,1.414,0l5-5a1,1,0,0,0,0-1.414L13,11.586V2A1,1,0,0,0,12,1Zm0,19.586L8.414,17,12,13.414,15.586,17ZM6,13A2.993,2.993,0,0,0,7,7.184V2A1,1,0,0,0,5,2V7.184A2.993,2.993,0,0,0,6,13ZM6,9a1,1,0,1,1-1,1A1,1,0,0,1,6,9Zm15,1a3,3,0,0,0-2-2.816V2a1,1,0,0,0-2,0V7.184A2.995,2.995,0,1,0,21,10Zm-4,0a1,1,0,1,1,1,1A1,1,0,0,1,17,10Z",
   },
   {
      scale: 5,
      type: "path",
